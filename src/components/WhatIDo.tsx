        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                Experience with database management, API integration, and performance optimization.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing AI-driven solutions including voice assistants and recommendation engines. 
                Specialized in integrating LLMs like Gemini API into practical, real-world tools.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Python</div>
